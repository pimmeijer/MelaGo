...
function postData() {
    ...
    if(question==0){
        jsondata = {"imgID": img1, "asymmetryScore": asymmetryScore, "duration": duration, "userID": user, "databaseType": "clear"};
    } else if(question==1){
        jsondata = {"imgID": img1, "borderScore": borderScore, "duration": duration, "userID": user, "databaseType": "clear"};
    } else if(question==2) {
        jsondata = {"imgID": img1, "colorScore": colorScore, "duration": duration, "userID": user, "databaseType": "clear"};
    }
    settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://medical-b854.restdb.io/rest/annotationdatacontrol",
        "method": "POST",
        "headers": {
            "content-type": "application/json",
            "x-apikey": "5addc30825a622ae4d528508",
  ...
  "data": JSON.stringify(userIDdata)
     ...
     if(question==0){
        jsondata = {"imgID": img2, "asymmetryScore": asymmetryScore2, "duration": duration, "userID": user, "databaseType": "clear"};
    } else if(question==1){
        jsondata = {"imgID": img2, "borderScore": borderScore2, "duration": duration, "userID": user, "databaseType": "clear"};
    } else if(question==2) {
        jsondata = {"imgID": img2, "colorScore": colorScore2, "duration": duration, "userID": user, "databaseType": "clear"};
    }
    settings = {
        "async": true,
        "crossDomain": true,
